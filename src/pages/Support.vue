  ...
  <q-page padding>
    <div class="text-center q-mt-md q-mb-lg">
      ...
      <div class="text-subtitle2">
        The ultimate day planner &amp; deadline tracker.
      </div>
        ...
        <q-card class="full-height column justify-between">
          <q-card-section>
            ...
            <div class="text-body1">
              Join our Discord community for detailed questions, discussions,
      ...
      <div class="col-12 col-sm-6 col-md-4 q-pa-sm">
        <q-card class="full-height column justify-between">
          <q-card-section>
            ...
            <div class="text-body1">
              View the source code, make contributions, create issues and pull
              requests.
            </div>
          </q-card-section>
          <q-card-actions>
